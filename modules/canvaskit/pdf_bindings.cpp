...
EMSCRIPTEN_BINDINGS(Pdf) {
    ...
    function("MakePDFDocument", optional_override([](SkWStream& stream, SimplePDFMetadata metadata)->sk_sp<SkDocument> {
        ...
        delete pdfMetadata.fStructureElementTreeRoot; // Clean up the root tag as SkPDF::Metadata does not take ownership of it.
        return document;
    }));
